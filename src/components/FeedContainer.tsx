...
import { colorFill, pencil, trash, heart, heartOutline } from 'ionicons/icons'; // <-- Added heart icons
      ...
      prevPosts.map(post =>
        post.post_id === postId
          ? {
              ...
              likes: post.liked_by_user ? (post.likes || 0) - 1 : (post.likes || 0) + 1
            }
          : post
      )
    );
            ...
            <IonCard>
              ...
              {posts.map(post => (
                ...
                <IonCardContent>
                    ...
                    {/* ❤️ Heart / Like Button */}
                    <IonButton onClick={() => toggleLike(post.post_id)} fill="clear">
                      <IonIcon
                        icon={post.liked_by_user ? heart : heartOutline}
                        style={{ color: post.liked_by_user ? 'red' : 'gray', fontSize: '24px' }}
                      />
                    </IonButton>
                    <IonText>
